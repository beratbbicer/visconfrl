...
if __name__ == "__main__":
    ...
    parser.add_argument('--rootname',\
        default=f'maze_solver_dql_{"".join(random.SystemRandom().choice(string.ascii_uppercase+string.ascii_lowercase+string.digits) for _ in range(5))}',\
    ...
    settings = f"Configuration {args.rootname} ->\n\
        ...
        episode_avg:{args.episode_avg}, render:{args.render}, dump:{args.dump}\n\
        ...
        full_maze:{args.full_maze}, maze_view_kernel_size:{args.maze_view_kernel_size}, epsilon: {args.epsilon}, weight_decay:{args.weight_decay}\n"
    print(settings)
