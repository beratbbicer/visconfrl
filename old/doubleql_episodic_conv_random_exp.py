...
def initiate_experiment(args):
    ...
    for episode in range(args.max_steps):
        ...
        if episode > args.eval_start and episode % args.eval_steps == 0:
            ...
            print(f"Episode: {episode:7d} -> Latest Eval Reward:{avg_reward: >7.3f}")
...
if __name__ == "__main__":
    ...
    parser.add_argument('--maze_view_kernel_size', default=11, type=int)
    ...
    writepath = f'./experiments/doubleql_conv_randexp/{args.mazepath.split("/")[-1].split(".pkl")[0].split("_")[-1]}/{args.rootname}'
