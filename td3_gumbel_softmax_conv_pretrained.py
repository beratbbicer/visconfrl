...
class AnnealedGumbelSoftmaxPolicy(nn.Module):
    def __init__(self, action_dim, weightspath, init_temperature=1.0, min_temperature=0.1, anneal_rate=1e-5):
        super(AnnealedGumbelSoftmaxPolicy, self).__init__()
        self.policy_net = PolicyNetwork(action_dim, weightspath)
...
def initiate_experiment(args):
    ...
    actor = AnnealedGumbelSoftmaxPolicy(args.action_dim, args.weightspath, args.init_temperature,\
    ...
    target_actor = AnnealedGumbelSoftmaxPolicy(args.action_dim, args.weightspath, args.init_temperature,\
                                        args.min_exporation_temperature, args.temperature_anneal_rate)
