...
class PolicyNetwork(nn.Module):
    def __init__(self, action_dim, path):
...
def initiate_experiment(args):
    ...
    actor = PolicyNetwork(args.action_dim, args.weightspath)
    critic = CriticNetwork(args.action_dim, args.weightspath, not args.unfreeze)
    target_actor = PolicyNetwork(args.action_dim, args.weightspath)
    target_critic = CriticNetwork(args.action_dim, args.weightspath, not args.unfreeze)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--weightspath', default='download/pretrain/2_101_101_0.9_0.9_1000000_1000_split/b05AIX0N/selection/e45.pth', type=str, help='Path to pretrained weights.')
    ...
    writepath = f'./experiments/doubleql_conv_pretrained/{args.mazepath.split("/")[-1].split(".pkl")[0].split("_")[-1]}/{args.rootname}'
    ...
    # python doubleql_episodic_conv.py --mazepath ./mazes_51/width-51_height-51_complexity-0.9_density-0.9_bbnYDPhsjerrENoS.pkl --dump --device 0 --maze_view_kernel_size
    # python doubleql_episodic_conv_pretrained.py --mazepath ./mazes_51/width-51_height-51_complexity-0.9_density-0.9_bbnYDPhsjerrENoS.pkl --weightspath ./download/pretrain/2_101_101_0.9_0.9_1000000_1000_split/b05AIX0N/selection/e45.pth --dump --device 1 --double